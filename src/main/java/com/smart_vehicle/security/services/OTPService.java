...
//    private UserDetailsServiceImpl parentService;
//
//    public OTPService(OTPGenerator oTPGenerator, EmailService emailService, UserDetailsServiceImpl parentService)
//    {
...
//    {
//    	 User user = userService.findParentByUsername(userName);
